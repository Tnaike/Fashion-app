            ...
            <div class="dashboard-section">
                <div class="slimScroll">
                    ...
                    <ul class="nav user-profile-menu">
                        ...
                        <li class=""><a href="wardrobe-monitor.php"><i class="fa fa-database"></i>Wardrobe <span><?php echo $pendPackage; ?></span></a></li>
                        <li class=""><a href="event-reminder.php"><i class="fa fa-calendar"></i>Event Reminder</a></li>
                        <li class="divider"></li>
