                        ...
                        <div class="page-header-wrap">
                            <ul class="nav">
                                <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 dashboard-title text-center">
                                    ...
                                    <span class="disp-inblock f-s-18 fw-6 pad-10">Add To Events</span>
                                </li>
                            </ul>
                        </div>
                                            ...
                                            <div class="measurement-datas">
                                                <div class="panel-wrap tabInput_wrap m-bt-10">
                                                    <div class="featured-p-tag bg-grey pad-10 m-bt-20">
                                                        <h2 class="text-center l-space-2 f-s-14 font-bold">Event Details</h2>
                                                    </div>
                                                    <div class="data__view">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <label class="control-label">Event Name <sup>*</sup></label>
                                                                <input type="text" name="eventName" id="eventName" class="form-control required">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <label class="control-label">Event Date <sup>*</sup></label>
                                                                <input type="text" name="eventDate" id="eventDate" class="form-control required">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <label class="control-label">Event Type <sup>*</sup></label>
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <label class="control-label">Event Location <sup>*</sup></label>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="eventNote" id="eventNote" rows="6" class="form-control" maxlength="160" placeholder="Write a short note here while receiving."></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
