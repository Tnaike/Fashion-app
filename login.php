...
<body>
    <div class="page-wrapper">
        ...
        <section id="login_account" class="login-section">
            <div class="container">
                <div class="row">
                    <div class="pc_acc-container section-20">                        
                        <div class="col-md-12 col-sm-12">
                            <h3 class="titleTag">Log In</h3>
                            <div class="log__ico" style="background:url(images/icons/measuring-tape.png); background-position:center; background-repeat:no-repeat;"></div>
                        </div>                        
                        <div class="accLog-wrap floatPos pad-20">
                        <?php include('errors.php'); ?>                            
                            <form action="login.php" id="form__input" method="post" class="inputForm">
                                <div class="col-sm-12 col-xs-12 input-fields">
                                    <div class="form-group clearfix">
                                        <label class="input_lbl">Email</label>
                                        <input type="text" name="userEmail" class="input_value email" placeholder="Email address">
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class="input_lbl">Password</label>
                                        <input type="password" name="password" class="input_value required" placeholder="Password">
                                    </div>
                                    <!-- <div class="clearfix m-bt-5">
                                        <div class="text-right f-s-12">
                                            <a href="forgot-password.htm" class="anchor-blue">Forget Password</a>
                                        </div>
                                    </div> -->
                                    <div class="clearfix">
                                        <button type="submit" name="btnLogin" class="submit_btn btn_primary disp_block m-bt-10">Log In</button> 
                                    </div>
                                    <!-- <div class="linkwrap clearfix">    
                                        <p class="text-center f-s-12">Don't have an account? <a href="register.php" class="anchor-blue">Register</a></p>
                                    </div> -->
                                  </div>
                            </form>
                        </div>
